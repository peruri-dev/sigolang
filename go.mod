...
require (
	...
	github.com/peruri-dev/inatrace v1.1.0
...
require (
	...
	github.com/peruri-dev/inalog/integrations/logtint v1.0.0 // indirect
	github.com/peruri-dev/inatrace/integrations/uptrace v1.0.2 // indirect
